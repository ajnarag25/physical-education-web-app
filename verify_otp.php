            ...
            <br>
                ...
                <form action="functions.php" class="login-form" method="POST">
                    <div class="form-group">
                        <input type="number" class="form-control rounded-left" name="otp" placeholder="Enter OTP" required>
                    </div>
                    <div class="form-group text-center">
                        <br>
                        <a href="index.php" class="btn btn-secondary" name="login">Back</a>
                        <button type="submit" class="btn btn-danger" name="otp_submit">Submit</button>
                    </div>
                </form>
            </div>
        </div>
